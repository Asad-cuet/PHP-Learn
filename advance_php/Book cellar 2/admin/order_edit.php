...
if(isset($_REQUEST['update'])) {
      ...
      $e_id=$_REQUEST['e_id'];
      $e_quant=$_REQUEST['e_quant'];
      $e_price=$_REQUEST['e_price'];

      $update_query="UPDATE ordered_info SET Book_id='$e_id',Quantity='$e_quant',Price='$e_price' WHERE Order_id='$order_id'";
