...
<div class="w3-container my-desc"><h1>Search:<?php echo $search; ?> </h1></div>




 <?php
$search_query="SELECT * FROM post WHERE Title_name LIKE '%$search%' OR Description LIKE '%$search%'";
...
<div class="w3-container w3-padding w3-border-bottom">  <!-- news start -->
...
<div class="w3-container w3-padding w3-border-bottom">  <!-- news start -->
      ...
      <div class="w3-col" style="width:30%">  <!-- photot coloumn -->
 ...
 <img src="" style="width:100%;"class="">
      ...
      <div class="w3-container  w3-block">
       <div><h6 class="w3-text-blue  w3-left  w3-block my-desc">No result found</h6></div></a>
      ...
      <div class="w3-container w3-left">
      <h9 class=" w3-left my-desc" ></h9>
      </div>
      
      </div>
<p class="w3-right w3-small w3-gray w3-text-white"></p></a>
