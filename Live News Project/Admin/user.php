...
<div class="w3-bar">
    <div class="w3-bar-item"><h3>All Users</h3></div>
    <a class="w3-bar-item w3-right w3-button w3-red" href="add_user.php"><h4>Add User</h4></a>
</div>    
...
<th class="w3-center"><input type="submit"  name="delete_m_data" class="w3-button w3-green w3-hover-red" value="Delete" onclick="return confirm('Are you sure?')"></th>
</tr>
