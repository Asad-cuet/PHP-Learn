...
echo $time=my_time();
 $insert_query="INSERT INTO delivered(Order_id,Item,Book_id,Quantity,Item_price,Price,Delivery_charge,Customer_name,Email,Cell,Adrress,Time,Delivered_time) VALUES ('$order_id','$item','$book_id','$quant','$book_price','$f_price','$delivery','$c_name','$c_email','$c_cell','$c_address','$date','$time');";
