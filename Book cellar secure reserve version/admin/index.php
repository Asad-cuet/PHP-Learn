...
<?php                                          // PHP Area start
   ...
   function input_filter($data)
   {
      ...
      $data=stripslashes($data);  
       ...
       /*over:escapeshellcmd(),escapeshellarg(),mysqli_real_escape_string() 
...
<input required type="text" name="admin_user" class="w3-block w3-border"></div>
<br>
...
<div class="w3-container">
<input required type="password" name="admin_pass" class="w3-block w3-border"></div>
<br>
