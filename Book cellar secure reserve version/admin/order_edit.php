...
if(isset($_REQUEST['update'])) {
      ...
      $e_price=htmlspecialchars($_REQUEST['e_price']);
      ...
      $update_query="UPDATE ordered_info SET Book_id='$e_id',Quantity='$e_quant',Price='$e_price',Delivery_charge='$delivery' WHERE Order_id='$order_id'";
...
<h6 class="w3-left w3-margin-left">Total Price</h6>
<div class="w3-container">
<input type="text" name="e_price" class="w3-block w3-border" value="<?php echo $price; ?>"></div>
<br>
