...
while($row=mysqli_fetch_row($result)) {
   ...
   $item_price=htmlspecialchars($row[5]);
   $price=htmlspecialchars($row[6]);
   $delivery=htmlspecialchars($row[7]);
   $cust_name=htmlspecialchars($row[8]);
   $cust_email=htmlspecialchars($row[9]);
   $cust_cell=htmlspecialchars($row[10]);
   $cust_adrress=htmlspecialchars($row[11]);
   $order_date=htmlspecialchars($row[12]);
   $del_date=htmlspecialchars($row[13]);
   $s_r++;
