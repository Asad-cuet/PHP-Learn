...
<div class="w3-row w3-border w3-center"  style="background-color:#C1D5D5">
 <div class="w3-col l3 m3 s12  "><div class="w3-panel  "><img src="admin/uploads/<?php echo $pic; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" class="w3-center" style="width:100%;"></div></div>
 </div>
 <div class="w3-row "  style="background-color:#C1D5D5">
